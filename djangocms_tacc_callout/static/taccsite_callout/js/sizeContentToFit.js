/**
 * Size element to fit (when CSS cannot)
 *
 * - Manipulates attributes within existing markup.
 * - Transformations are NOT dynamically updated after initial load.
 *
 * This is an interim solution. CSS and server data should solve the problem.
 * @see https://github.com/TACC/Core-CMS/issues/327
 * @module sizeContentToFit
 */
